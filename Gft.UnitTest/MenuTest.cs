...
namespace Gft.UnitTest
{
    ...
    {
        [Test]
        [TestCase("manhã", "ovos, torrada, café", new int[] { 1, 2, 3 })]
        [TestCase("manhã", "ovos, torrada, café", new int[] { 2, 1, 3 })]
        [TestCase("manhã", "ovos, torrada, café, erro", new int[] { 1, 2, 3, 4 })]
        [TestCase("manhã", "ovos, torrada, café (x3)", new int[] { 1, 2, 3, 3, 3 })]
